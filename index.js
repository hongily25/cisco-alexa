...
const handlers = {
    ...
    'GetRoomIntent': function () {
        ...
        if (userToken == undefined) {
            ...
            request(options, function (error, response, body) {
                ...
                self.emit(':ask', "Ok. Here are your rooms: " + rooms + " . To get the latest message from your rooms, say 'read my messages' ","Ok. Here are your rooms: " + rooms + " . To get the latest message from your rooms, say 'read my messages' ");
                } else {
                    self.emit(':ask', "There are no rooms. You can say 'return to menu' or create a new room","There are no rooms. You can say 'return to menu' or create a new room")
                }
         });
        }
    },
            ...
            if (body.items[0] != undefined) {
                ...
                request(msgOptions, function (error, response, body) {
                    ...
                    if (body.items[0] != undefined) {
                        ...
                        self.emit(':ask', "Ok. Here is your last message from " + roomTitle + ". " + listOfMsgs + ". Would you like to know more? Say yes for more messages or no to return to the menu.");
                    } else {
                        self.emit(':tell', "There are no messages in " + roomTitle + " You can say 'Return to menu' for more options.");
                    }
                });
            } else {
                self.emit(':ask', 'There are no rooms. Please create a room or return to the menu.')
            }
        });
    },
            ...
            if (body.items[index] != undefined) {
                ...
                request(msgOptions, function (error, response, body) {
                    ...
                    if (body.items[0] != undefined) {
                        ...
                        console.log('msgs ' + body.items[0].text);
                        console.log('list of msgs: ' + listOfMsgs);
                        self.emit(':ask', "Ok. Here is your last message from " + roomTitle + ". " + listOfMsgs + ". Would you like to read your next message? Say yes for more messages or no to return to the menu.","Would you like to read your next message? Say yes for more messages or no to return to the menu.");
                    } else {
                        self.emit(':ask', "There are no messages from " + roomTitle + ". Would you like to read your next message? Say yes for more messages or no to return to the menu. ","Would you like to read your next message? Say yes for more messages or no to return to the menu.");
                    }
                });
            } else {
                index = 1;
                console.log('index: ' + index);
                self.emit(':ask', "There are no more messages. You can say 'Return to menu' ", "There are no more messages. You can say 'Return to menu' ");
            }
        });
    },
    'NewRoomIntent': function () {
        ...
        if (userTitle == undefined) {
            self.emit(':ask', "What should the room be called? For example, say 'New Room'", "What should the room be called? For example, say 'New Room'");
        }
        var options = {
            url: 'https://api.ciscospark.com/v1/rooms',
            headers: {
        ...
        if (userToken == undefined) {
            ...
            request(options, function (error, response, body) {
                ...
                if (body.items[0] != undefined) {
                    ...
                    if (body.items.length == 1) { teamsPhrase = "Here is your team: " };
    ...
    'AMAZON.NoIntent': function () {
        this.emit(':ask', "Here is your menu: You can say 'list my rooms', 'read my messages', or 'create a new room'","Here is your menu: You can say 'list my rooms', 'read my messages', or 'create a new room'");
    },
    'MenuIntent': function () {
